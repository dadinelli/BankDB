...
--1. Query che mostra tutti i conti di una banca specifica e i dettagli dei loro titolari: OK
...
--2. Seleziona il numero totale di conti per ogni banca, con un raggruppamento per banca: OK
...
--3. Conta il numero di transazioni effettuate dal cliente e calcola il totale degli importi delle transazioni: OK
...
--4. Seleziona il totale delle transazioni per ogni conto inviante (Sender) con un saldo superiore a 1000 euro, utilizzando HAVING e creando un INDICE: OK
...
--5. Seleziona il numero di dipendenti per ogni filiale specificando l'indirizzo  OK
...
--6. Seleziona lo stipendio per ogni dipendente	OK
